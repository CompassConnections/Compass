          ...
          >
            <p className="text-sm font-medium text-ink-900 sm:text-[15px]">
              {t(
                ...
                `Compass is in its early growth phase — 900+ members and ~100 new people joining every month. Build a strong profile now and be visible as the community expands.`,
              )}
            </p>
          </ProfileBanner>
        )}
