...
const optionalProfilesSchema = z.object({
  ...
  psychedelics: z.string().optional().nullable(),
  cannabis: z.string().optional().nullable(),
  psychedelics_intention: z.array(z.string()).optional().nullable(),
  cannabis_intention: z.array(z.string()).optional().nullable(),
  psychedelics_pref: z.array(z.string()).optional().nullable(),
  cannabis_pref: z.array(z.string()).optional().nullable(),
