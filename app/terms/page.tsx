  ...
  return (
    <main className="max-w-4xl mx-auto p-8 text-gray-800 dark:text-white">
      ...
      <section className="space-y-6 text-base leading-relaxed">
        <p>
          Welcome to <span className="font-semibold">BayesBond</span>, a platform designed for
        ...
        <p>
          You must be at least 15 years old to create an account and use BayesBond.
        ...
        <p>
          ...
          the BayesBond community. All governance decisions will be made publicly
          available.
        </p>
        <p>
        ...
        <p>
          BayesBond is not responsible for disputes between users or for damages arising
          from the use of the platform. Use the platform at your own discretion.
        </p>

        <h2 className="text-xl font-semibold">5. Changes</h2>
        <p>
          We may update these Terms periodically. Continued use of BayesBond after updates
