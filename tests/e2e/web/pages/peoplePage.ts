...
export class PeoplePage {
    ...
    async setLifestyleFilter(lifestyle: LifestyleFilter) {
        ...
        if(lifestyle.psychedelics) await this.selectOption(this.lifestylePsychedelics, lifestyle.psychedelics[0])        
    ...
    async setValuesAndBeliefsFilter(values: BeliefsFilter) {
        ...
        if(values.political) await this.selectOption(this.valuesAndBeliefsPolitics, values.political[0])
